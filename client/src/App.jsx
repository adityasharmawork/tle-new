        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            ...
            <div className="font-thin">
                    <p className='text-lg font-bold'>TLE <span className='text-[#F83002]'>CP-Tracker</span> &copy; {new Date().getFullYear()}</p>
            </div>
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href="https://x.com/TLE_Eliminators" className="hover:text-gray-400" aria-label="Twitter" target="_blank">
            ...
            <a href="https://www.linkedin.com/company/tle-eliminators/" className="hover:text-gray-400" aria-label="LinkedIn" target="_blank">
